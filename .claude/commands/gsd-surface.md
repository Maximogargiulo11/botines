...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/botines/.claude/.gsd-surface.json`
(sibling to `/home/user/botines/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/botines/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/botines/.claude/skills`).
...
`/home/user/botines/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/botines/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/botines/.claude/.gsd-surface.json`
Install profile marker: `/home/user/botines/.claude/.gsd-profile`
Skill dirs: `/home/user/botines/.claude/skills/gsd-*/`
Engine module: `/home/user/botines/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/botines/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
