...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/botines/.claude
                  → checks /home/user/botines/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/botines/.claude/gsd-core
                  → writes to /home/user/botines/.claude/gsd-core/hooks/
