...
```
Agent(
  prompt="Read /home/user/botines/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/botines/.claude/gsd-core/templates/SECURITY.md`
