...
@/home/user/botines/.claude/gsd-core/references/mandatory-initial-read.md
...
**Project skills:** @/home/user/botines/.claude/gsd-core/references/project-skills-discovery.md
- Load `rules/*.md` as needed during **planning**.
- Ensure plans account for project skill patterns and conventions.

**agent_skills:** self-load per @/home/user/botines/.claude/gsd-core/references/agent-skills-bootstrap.md
</project_context>
...
@/home/user/botines/.claude/gsd-core/references/planner-source-audit.md for full format, examples, and gap-handling rules.
...
@/home/user/botines/.claude/gsd-core/references/planner-source-audit.md for constraint examples.
...
See @/home/user/botines/.claude/gsd-core/references/planner-guidance.md for planning philosophy (Solo Developer workflow, Plans Are Prompts, Quality Degradation Curve, Ship Fast).
...
**<reversibility>** (optional): `rating="reversible|costly|one-way"` + one-line rationale for a decision this task implements. `one-way` inserts a `checkpoint:decision` before this task; `costly` is flagged only; unsure means `reversible`. Rules: @/home/user/botines/.claude/gsd-core/references/planner-reversibility.md

See @/home/user/botines/.claude/gsd-core/references/planner-guidance.md for Task Types table, Task Sizing rules, Interface-First Task Ordering, and Specificity guidance.

## TDD Detection

**When `workflow.tdd_mode` is enabled:** Apply TDD heuristics aggressively — all eligible tasks MUST use `type: tdd`. Read @/home/user/botines/.claude/gsd-core/references/tdd.md for gate enforcement rules and the end-of-phase review checkpoint format.
...
See @/home/user/botines/.claude/gsd-core/references/planner-guidance.md for User Setup Detection protocol (external service indicators, env vars, dashboard config).

</task_breakdown>

<dependency_graph>

See @/home/user/botines/.claude/gsd-core/references/planner-guidance.md for dependency graph building rules and file ownership for parallel execution.
...
Full rules: @/home/user/botines/.claude/gsd-core/references/context-budget.md (Phase Sizing). Read before sizing.
...
<execution_context>
@/home/user/botines/.claude/gsd-core/workflows/execute-plan.md
@/home/user/botines/.claude/gsd-core/templates/summary.md
</execution_context>
...
See @/home/user/botines/.claude/gsd-core/references/planner-guidance.md for a worked example and the `must_haves` YAML format.
...
@/home/user/botines/.claude/gsd-core/references/planner-antipatterns.md
...
@/home/user/botines/.claude/gsd-core/references/thinking-models-planning.md
...
See @/home/user/botines/.claude/gsd-core/references/planner-guidance.md for `## PLANNING COMPLETE` and `## GAP CLOSURE PLANS CREATED` return format templates.

See @/home/user/botines/.claude/gsd-core/references/planner-chunked.md for `## OUTLINE COMPLETE` and `## PLAN COMPLETE` return formats used in chunked mode.
